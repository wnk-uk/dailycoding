package com.dailycoding.domain;

import com.dailycoding.account.UserAccount;
import lombok.*;
...
public class Study {
    ...
    public String getImage() { return image != null ? image : "/images/default_banner.png"; }
